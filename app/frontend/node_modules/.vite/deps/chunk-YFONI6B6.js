...
setVersion("@fluentui/react-hooks", "8.10.1");
...
setVersion("@fluentui/react-window-provider", "2.3.1");
...
setVersion("@fluentui/utilities", "8.17.1");

// node_modules/@fluentui/react-hooks/lib/useAsync.js
var React22 = __toESM(require_react());
function useAsync() {
  var asyncRef = React22.useRef(void 0);
  if (!asyncRef.current) {
...
function useTarget(target, hostElement) {
  var _a3, _b, _c;
  var previousTargetProp = React38.useRef(void 0);
  var targetRef = React38.useRef(null);
...
var useUnmount = function(callback) {
  var unmountRef = React39.useRef(callback);
...
function useWarnings(options) {
  if (true) {
    ...
    var hasWarnedRef = React40.useRef(false);
...
//# sourceMappingURL=chunk-YFONI6B6.js.map
