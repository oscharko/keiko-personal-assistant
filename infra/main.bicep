...
// Beta authentication for testing (temporary, will be replaced by Azure AD)
param betaAuthEnabled string = ''
param betaAuthUsers string = ''
@secure()
param betaAuthSecretKey string = ''
